        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingNumber = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowedTime = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthorEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorsBooks", x => new { x.AuthorEntityId, x.BookEntityId });
                    table.ForeignKey(
                        name: "FK_AuthorsBooks_Authors_AuthorEntityId",
                        column: x => x.AuthorEntityId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorsBooks_Books_BookEntityId",
            ...
            migrationBuilder.CreateTable(
                name: "ProlongingRequests",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsAproved = table.Column<bool>(type: "bit", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    PrologingDays = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProlongingRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProlongingRequests_Books_BookEntityId",
                        column: x => x.BookEntityId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenresBooks", x => new { x.GenreEntityId, x.BookEntityId });
                    table.ForeignKey(
                        name: "FK_GenresBooks_Books_BookEntityId",
                        column: x => x.BookEntityId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenresBooks_Genres_GenreEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LibrarianId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserEntityId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookReservations_Books_BookEntityId",
                        column: x => x.BookEntityId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UsersEntityId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorsBooks_BookEntityId",
                table: "AuthorsBooks",
                column: "BookEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_BookReservations_BookEntityId",
                table: "BookReservations",
                column: "BookEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_BookReservations_UserEntityId1",
                table: "BookReservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_UsersEntityId",
                table: "Comments",
                column: "UsersEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_GenresBooks_BookEntityId",
                table: "GenresBooks",
                column: "BookEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_UserEntityId1",
                table: "Notifications",
                column: "UserEntityId1");

            migrationBuilder.CreateIndex(
                name: "IX_ProlongingRequests_BookEntityId",
                table: "ProlongingRequests",
                column: "BookEntityId");
